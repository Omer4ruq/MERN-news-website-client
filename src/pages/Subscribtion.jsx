...
const Subscribtion = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const premiumTakenRes = await axiosPublic.patch(`/userspremium`, {
      email,
      subscriptionPlan,
    });
    console.log(premiumTakenRes.data).then((res) => {
      if (premiumTakenRes.data.insertedId) {
        Swal.fire({
          position: "top-end",
          icon: "success",
          title: "premium Succesfully",
      ...
      <section className="py-20 bg-gray-800 text-gray-100">
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto mb-16 text-center">
            <span className="font-bold tracki uppercase text-violet-400">
              Pricing
            </span>
          ...
          <div className="flex flex-wrap items-stretch -mx-4">
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-900">
                ...
                <p className="mt-3 leadi text-gray-400">
            ...
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-900">
                ...
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="inline-block w-full px-5 py-3 font-semibold tracki text-center rounded bg-violet-400 text-gray-900"
                >
                  Get Started
                </a>
              </div>
